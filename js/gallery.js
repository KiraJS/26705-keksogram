...
define(function() {
  ...
  /**
   * Метод показывает текущую фотографию.
   * @private
   */
  ...
  /**
   * Метод записывает в приватное свойство _currentPhoto индекс текущей показанной фотографии,
   * показывает ее на экране и пишет ее номер в соответствующем блоке.
   */
